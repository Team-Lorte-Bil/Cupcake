            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner text-center rounded">
                    <h2 class="section-heading mb-5">
                        ...
                        <span class="section-heading-lower" style="font-size: 23px;">Der skete <em>404</em> fejl! 😱</span>
                        <span class="section-heading-lower" style="font-size: 17px;">Og ud af de 404 fejl, kunne vi ikke finde den side du prøvede at tilgå 🙃</span>
                    </h2>
