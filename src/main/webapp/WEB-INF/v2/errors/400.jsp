            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner text-center rounded">
                    <h2 class="section-heading mb-5">
                        ...
                        <span class="section-heading-lower" style="font-size: 23px;">Der skete <em>400</em> fejl! 😱</span>
                        <span class="section-heading-lower" style="font-size: 17px;">Vi har knas i linjen. Prøv igen senere!</span>
                    </h2>
