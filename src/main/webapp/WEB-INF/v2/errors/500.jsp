...
<body style="background: linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('assets/img/cupcakes-4068129_1920.jpg') repeat;background-size: auto, cover;font-family: Raleway, sans-serif;">
<h1 class="text-center text-white d-none d-lg-block site-heading"><span class="site-heading-lower">Olsker Cupcakes</span></h1>
<nav class="navbar navbar-dark navbar-expand-md bg-dark navigation-clean-button" style="font-family: Raleway, sans-serif;font-weight: 800;height: 72px;">
            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner text-center rounded">
                    <h2 class="section-heading mb-5">
                        ...
                        <span class="section-heading-lower" style="font-size: 23px;">Der skete <i>500</i> fejl! 😱</span>
                        <span class="section-heading-lower" style="font-size: 17px;">Og ud af de 500 fejl, fandt vi ud af at det faktisk er os der har fejlet 😱</span>
                    </h2>
