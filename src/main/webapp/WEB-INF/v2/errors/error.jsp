            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner text-center rounded">
                    <h2 class="section-heading mb-5">
                        ...
                        <span class="section-heading-lower" style="font-size: 23px;">Der skete en fejl! 😱</span>
                        <span class="section-heading-lower" style="font-size: 17px;"><%=request.getAttribute("javax.servlet.error.message")%></span>
                    </h2>
